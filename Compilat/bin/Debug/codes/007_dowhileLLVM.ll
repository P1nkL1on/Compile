@str5 = private unnamed_addr constant [5 x i8] c"aaaa\00"
; puts int ( char* )
...
Whileaction1:
  %tmp1 = call i32 @puts(i8* getelementptr ([5 x i8], [5 x i8]* @str5, i64 0, i64 0))
  %tmp2 = sub i32 %$1_0i, 3
  store i32 %tmp2, i32* %_0i
  %$2_0i = load i32, i32* %_0i
  br label %Whilecond1
Whilecond1:
  %tmp5 = icmp sgt i32 %$2_0i, 10
  %tmp4 = icmp eq i1 %tmp5, 1
  %cond1 = icmp %tmp4
