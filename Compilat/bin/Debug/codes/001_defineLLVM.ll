@str8 = private unnamed_addr constant [5 x i8] c"okay\00"
@str9 = private unnamed_addr constant [11 x i8] c"here we go\00"
...
define i32 @main() #0 {
  ...
  %_17S = alloca i8*
  store i8* getelementptr ([5 x i8], [5 x i8]* @str8, i64 0, i64 0), i8** %_17S
  %_18S2 = alloca i8*
  store i8* getelementptr ([11 x i8], [11 x i8]* @str9, i64 0, i64 0), i8** %_18S2
  %_19S3 = alloca i8*
  store i8* getelementptr ([1 x i8], [1 x i8]* @str10, i64 0, i64 0), i8** %_19S3
  %_20TR = alloca i1
  store i1 1, i1* %_20TR
  %_21FL = alloca i1
  store i1 0, i1* %_21FL
