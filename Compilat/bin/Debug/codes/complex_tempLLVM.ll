...
Forcond4:
  ...
  %cond4 = icmp slt i32 %$2_3i, 100

  br i1 %cond4, label %Foraction4, label %Forcont4
Foraction4:
;If
  %cond3 = icmp slt i32 %$2_3i, 50

  br i1 %cond3, label %Ifthen3, label %Ifelse3
Ifthen3:
  %tmp2 = mul i32 %$2_3i, 10
  %tmp1 = add i32 %tmp2, %$1_2s
  store i32 %tmp1, i32* %_2s
  %$2_2s = load i32, i32* %_2s

  br label %Ifcont3
Ifelse3:
  %tmp6 = mul i32 %$2_3i, 5
  %tmp5 = sub i32 %$2_2s, %tmp6
