...
define i32 @$0Declared(i32 %_0a1, i32 %_1a2, double %_2d1) #0 {
...
define void @OnlyArgs(i8 %_0c, i32 %_1b, i8 %_2D, double %_3E) #6 {
  ret void
}


; OnlyArgs void ( char, int, int, int )
define void @$0OnlyArgs(i8 %_0c, i32 %_1b, i32 %_2D, i32 %_3E) #7 {
  ret void
}
...
define i32 @main(i32 %_0argc, i8** %_1args) #8 {
  ...
  tail call void @$0OnlyArgs(i8 99, i32 10, i32 1, i32 2)
  %tmp5 = add i32 2, 1
  %tmp7 = fmul double 1.2, 20.0
  tail call void @OnlyArgs(i8 102, i32 %tmp5, i8 102, double %tmp7)
  tail call void @OnlyArgs(i8 99, i32 10, i8 107, double 23.3)
  ret i32 0
}
